...
function testSettingSpriteImage() {
    ...
    Assert.assertNumber("sprite pixel 0,0", sprite.pixel(0, 0).colour.red, 0)
    Assert.assertNumber("sprite pixel 0,0", sprite.pixel(0, 0).colour.green, 0)
    Assert.assertNumber("sprite pixel 0,0", sprite.pixel(0, 0).colour.blue, 0)
    Assert.assertNumber("sprite pixel 0,1", sprite.pixel(0, 1).colour.red, 255)
    Assert.assertNumber("sprite pixel 0,1", sprite.pixel(0, 1).colour.green, 255)
    Assert.assertNumber("sprite pixel 0,1", sprite.pixel(0, 1).colour.blue, 255)
